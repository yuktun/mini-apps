(function(){
  ...
  const written=(id,section,printedNo,page,sentenceParts,answers,displayAnswer,grammarPoint,explanationZh,meaningZh,options={})=>({
    ...
    grammarPoint,explanationZh,meaningZh,hintZh:options.hintZh||"請留意空格前後的助詞、接續及句子意思。",grammarCard:options.grammarCard||null,sourceCertainty:options.sourceCertainty||"certain",adaptation:options.adaptation||"exact"
  });
  const choice=(id,section,printedNo,page,prompt,choices,answer,completeSentence,grammarPoint,explanationZh,meaningZh,options={})=>({
    ...
    hintZh:options.hintZh||"先確認文法接續，再判斷整句意思。",grammarCard:options.grammarCard||null,sourceCertainty:options.sourceCertainty||"certain",adaptation:options.adaptation||"controlled"
  });
  ...
  window.TEACHER_FINAL_REVIEW_QUESTIONS=[
    ...
    written("teacher-review-g02","grammar","2",1,["A：原稿は今日出さなければなりませんか。\nB：","も構いませんよ。"],[["明日で","あしたで"]],["明日で"],"Nでも構わない","空格後已印有「も構いませんよ」，所以只填「明日で」，組成「明日でも構いませんよ」。不要把已印出的「も」重複寫進空格。","A：稿件必須今天交嗎？ B：明天交也沒問題。",{adaptation:"exact-model-answer",grammarCard:"～てもかまわない",hintZh:"「も」已經印在空格後；請填表示可接受替代日期的「明日＋で」。"}),
    written("teacher-review-g03","grammar","3",1,["","ほど","はない。"],[["スポーツのあとに飲むビール"],["おいしいもの"]],["スポーツのあとに飲むビール","おいしいもの"],"XほどYはない／いない","第9課的安全示範句是「スポーツのあとに飲むビールほどおいしいものはない」。第一格放比較基準X，第二格放被否定為無可比擬的Y。","沒有任何東西比運動後喝的啤酒更美味。",{sourceCertainty:"model-answer-reference",adaptation:"exact-model-answer",grammarCard:"～ほど～はない／いない",hintZh:"使用「XほどYはない」：第一格寫X，第二格寫Y。"}),
    written("teacher-review-g04","grammar","4",1,["","のは、","ためだ。"],[["空港が使えなくなった"],["大雪が降った"]],["空港が使えなくなった","大雪が降った"],"YのはXためだ（原因・理由）","「YのはXためだ」先提出結果Y，再以X說明正式原因。本題的「ため」表示原因，不表示目的。","機場無法使用，是因為下了大雪。",{sourceCertainty:"model-answer-reference",adaptation:"exact-model-answer",grammarCard:"～ために／～ためだ（原因）",hintZh:"第一格寫結果，第二格寫造成該結果的原因。"}),
    written("teacher-review-g05","grammar","5",1,["A：あれ？Bさん、出張の予定が変わったんですか。\nB：そうなんです。聞いてくださいよ！私が行くはずだったのに、","んです！"],[["ほかの人が行くことになった","他の人が行くことになった"]],["ほかの人が行くことになった"],"～はずだったのに／～ことになった","原本預定由自己出差，用「私が行くはずだった」；其後安排改變，用「ほかの人が行くことになった」。空格後已有「んです」，不要在答案末尾再寫一次。","A：咦？B先生，出差安排改了嗎？ B：是啊！原本應該由我去，結果改成由其他人去了！",{sourceCertainty:"model-answer-reference",adaptation:"exact-model-answer",grammarCard:"～はずだった",hintZh:"寫出「安排改為由其他人前往」；空格後已有「んです」。"}),
    written("teacher-review-g06","grammar","6",1,["私の子どもはいつも服を脱いだら、","っぱなしだ。"],[["脱ぎ","ぬぎ"]],["脱ぎ"],"Vます形＋っぱなし","「脱ぐ」的ます形是「脱ぎます」，去掉「ます」後接「っぱなし」，所以填「脱ぎ」。","我的孩子總是脫下衣服後便一直放著不處理。",{grammarCard:"～っぱなし",hintZh:"「脱ぐ」要先變成ます形詞幹；空格後已有「っぱなし」。"}),
    ...
    written("teacher-review-g08","grammar","8",2,["A：何時ごろお","ですか。\nB：8時ごろ戻ります。"],[["戻り","もどり"]],["戻り"],"お＋Vます形＋です","「戻ります」去掉「ます」得到「戻り」，構成尊敬表達「お戻りですか」。","A：您大約幾點回來？ B：大約八點回來。",{grammarCard:"お＋Vます形（去ます）＋です",hintZh:"空格前已有「お」，後面已有「ですか」；請填「戻る」的ます形詞幹。"}),
    written("teacher-review-g09","grammar","9",2,["私は掃除は毎日","より、週末にまとめて","ほうが効率がいいと思っている。"],[["する"],["する"]],["する","する"],"VるよりVるほうが","比較兩種做法時，兩邊都使用動詞辭書形：「毎日するより、週末にまとめてするほうが」。","我認為與其每天打掃，不如在週末集中打掃更有效率。",{grammarCard:"YよりXほうが～"}),
    written("teacher-review-g10","grammar","10",2,["A：今度お宅に遊びに行ってもいい？\nB：あ、あ、すみません。家は……。\nA：あ、ごめんね。そうだよね。\nB：いえ、あの、","ものですから……。"],[["今ちょっと部屋が片付いていない","いまちょっとへやがかたづいていない"]],["今ちょっと部屋が片付いていない"],"～もの／ものですから","「ものですから」用來婉轉說明個人理由或藉口。題目已印出「ものですから」，所以空格只寫其前面的理由。","A：下次可以到你家玩嗎？ B：那個……因為現在房間還有點沒有收拾好……。",{sourceCertainty:"model-answer-reference",adaptation:"exact-model-answer",grammarCard:"～もの／もんだから",hintZh:"空格後已有「ものですから」；只寫「房間現在還未收拾好」這個理由。"}),
    written("teacher-review-g11","grammar","11",2,["A：私は2年前に日本語能力試験N1に","います。\nB：そうですか。N1って、すごいですね。"],[["合格して","ごうかくして"]],["合格して"],"Vている（經歷／結果狀態）","「合格する」的て形是「合格して」，接題目外的「います」成為「合格しています」。","A：我兩年前通過了日語能力試驗N1。 B：是嗎？N1很厲害呢。",{grammarCard:"～ている（經驗／經歷）",hintZh:"空格後已有「います」，請填「合格する」的て形。"}),
    written("teacher-review-g12","grammar","12",2,["","た結果、","がわかった。"],[["調査し","ちょうさし"],["この町の人口が減ってきていること","このまちのじんこうがへってきていること"]],["調査し","この町の人口が減ってきていること"],"Vた結果","「た結果」已印在第一格後，所以第一格只寫「調査し」，合起來成為「調査した結果」。第二格以「こと」把「人口が減ってきている」名詞化，再接題目已印出的「がわかった」。","調查後得知這個城鎮的人口正逐漸減少。",{sourceCertainty:"model-answer-reference",adaptation:"exact-model-answer",grammarCard:"～た結果／～の結果",hintZh:"第一格後已印有「た結果」；第二格要把調查得知的整件事名詞化。"})
  ];
})();
