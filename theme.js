(function(){
  ...
  style.textContent=`
    ...
    html[data-theme="dark"] .panel,html[data-theme="dark"] .toolbar,html[data-theme="dark"] .tabs,html[data-theme="dark"] .card,html[data-theme="dark"] .front,html[data-theme="dark"] .back,html[data-theme="dark"] .choice,html[data-theme="dark"] .exercise,html[data-theme="dark"] .phrase-card,html[data-theme="dark"] .modal-card,html[data-theme="dark"] .grammar-modal,html[data-theme="dark"] .review-panel,html[data-theme="dark"] .mini,html[data-theme="dark"] .vocab-row,html[data-theme="dark"] .sentence-item,html[data-theme="dark"] .drop-slot,html[data-theme="dark"] .word-bank,html[data-theme="dark"] .token-area,html[data-theme="dark"] .summary-table{background:#111c2e!important;color:#e5edf7!important;border-color:#334155!important}
    ...
    html[data-theme="dark"] .subtitle,html[data-theme="dark"] .desc,html[data-theme="dark"] .cue,html[data-theme="dark"] .progress,html[data-theme="dark"] .speaker,html[data-theme="dark"] .meta,html[data-theme="dark"] .hint,html[data-theme="dark"] .explain,html[data-theme="dark"] .lesson,html[data-theme="dark"] label,html[data-theme="dark"] #savedInfo,html[data-theme="dark"] #savedText{color:#a9b8ca!important}
  ...
  window.setInterval(()=>{if(mode==='auto')applyTheme()},60000);
})();
